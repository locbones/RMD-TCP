--- Filter Title: Sheep's Filter v1.02
...
return {
    reload = "{pink}Sheep's Base Filter v1.02 {grey} updated 8/30/25 {Green}Reloaded",
    rules = {
        ---Rule 0: Runewords beg you to keep them.
        { 
             codes = "allitems",
        ...
        ---Rule 0b Bonesy: please stop breaking things I mean...shows number of sockets 
        { 
            codes = "allitems",
            sockets = "1+",
            suffix = "{turquoise}({sockets})"
        },
         --- Rule 0c: Hides scrolls on ground 
        {
            codes = { "tsc", "isc"},
            hide = true, 
        ...
        ---Rule 0e: hide all non rare or greater arrows over 60 
        {
            code = "aqv",
            quality = "4-",
            hide = true, 
       ...
       ---Rule 5: High Runes notification and ultra rune border and colors  
        ...
        ---Rule 6: Unique Archons (Color swap?)  
        {
            ...
            background = { 255, 255, 255, 255 },
            prefix = "ÿcE",
            notify = "ÿcERare Unique Nearby: {name}",
            border = { 240, 0, 0, 230, 2 } 
        }, 
        ---Rule 7: Potential high quality uniques (ie hydra master)(color swap?) 
        {
            ...
            notify = "ÿcOVariable Unique Nearby: {name}",
        ...
        {
            codes = { "b64","b65","Rgx","Ev0", "y09", "y10", "y11", "y12", "y13", "y14", "y15", "y16", "y17", "y18", "y19", "y20", "y21", "y22", "y23", "y24", "y25", "y26", "y27", "y28", "y29", "y30", "y31", "y32", "y33" },
            notify = "ÿc;Treasure Nearby: {name}",
        ...
        ---Rule 11: Valuable Uniques (would be better to use unique indexing but lazy) 
        {
            ...
            quality = 7,
            notify = "ÿcSQuality Unique Nearby: {name}",
            border = { 255, 128, 0, 230, 2 } 
        },
        --- Rule 12: Hides zero skill paladin weapons.  
        {
        ...
        { 
            ...
            suffix = "{Red}|LB|" --Limitbreaking base Subject to change obv
        },
        ...
        { 
            codes = {"l01", "l02", "l03", "l04", "l05", "l06", "l07", "l08", "l09", "l10", "l11", "l12", "l13", "l14", "l15", "l16", "l17"},
            quality = "7",
            notify = "LimitBreak Unique Nearby: {name}",
            border = { 255, 128, 0, 230, 2 } ,
        },
