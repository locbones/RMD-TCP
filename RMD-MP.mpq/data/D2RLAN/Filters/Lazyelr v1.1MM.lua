...
return {
    debug = false,
    reload = "{red}Lazyelr v1.1MM  {grey}Last Updated: 25/07/2025 13:55 elrtime {green}[Reloaded] ",
    rules = { --This version of the filter comes with moderate-strong filtering of bases in Hell Cows, to remove this, delete all rules after line 133
