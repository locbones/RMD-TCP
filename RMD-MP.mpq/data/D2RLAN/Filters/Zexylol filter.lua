--- Filter Title: Zexylol's Hardfilter
...
--[[				Rule 1-9 shows sockets, runewords, tempered, crafted, low/mid/hi/ultra runes, tempering souls.
		...
		--Rule 8, High rune name with notify.
		{
		codes = { "r34", "r35", "r36"},
		name_style = "Rainbow",
		suffix = "\n Ultra Points Rune",
...
--[[				Rule 49-53 Shows all SUPERIOR ITEMS with max suffix stat and border + notify
		...
		-- Rule 49, 
		{
			...
			{ index = { 333, 187}, op = "==", value = 10 }, --MAX -ENEMY RES! / IMMUNITY!
			{ index = { 93, 105}, op = "==", value = 15 }, --MAX ATTACKSPEED! / CASTSPEED
						},
			border = { 255, 128, 0, 230 },
			notify = "Maxed Supperior!",
			name_style = "Rainbow",
			suffix = "\n Maxed Supperior!",		
		},
		-- Rule 50,
...
--[[				Rule 54-   MISC OR THINGS I FORGOT.
		...
		--Rule 55, Hide Gems, if you want to get gems, change: hide = true, to: false, .
		{
			codes = { "gcr", "gcy", "gcb", "gsy", "gfv", "gfw", "gfy", "gfb", "skf", "gfg", "gsg", "sku", "gsr", "gsv", "gsw", "gfr", "gsb", "glb", "glw", "gzv", "glg", "skl", "glr", "skc", "gly"},
			hide = true,
			area = NOT { "Rogue Encampment", "Lut Gholein", "Kurast Docktown", "The Pandemonium Fortress", "Harrogath" },			
